...
export const LeaveBalanceChart = ({ data }) => {
  const chartData = [
...
export const WorkloadTrendChart = ({ data }) => {
  return (
...
export const LeaveStatusPieChart = ({ data }) => {
  return (
    <ResponsiveContainer width="100%" height={250}>
      <PieChart>
        <Pie
...
export const TeamAvailabilityChart = ({ available, onLeave }) => {
  const data = [
